<?php
 if(isset($_POST['email'])) {
     $email_to = "dannylo9891@gmail.com";
     ...
     $website = $_POST['website']; // obligatorio
 ...
 ?>
 <meta http-equiv="refresh" content="3;index.php" /><!-- Redireccionar a pagina principal despues de 3 segundos -->
